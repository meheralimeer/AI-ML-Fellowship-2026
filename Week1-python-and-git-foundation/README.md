...
Python fundamentals and version control basics for the AI/ML Fellowship at GDGOC COMSATS Attock.

## Tasks

### Task 1 - Python Basics
Basic Python programs covering:
